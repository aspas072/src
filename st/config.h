 ...
 */
static char *font = "FiraCodeNerdFont:pixelsize=14:antialias=true:autohint=true";
static char *font2[] = { "FiraCodeNerdFont:pixelsize=14:antialias=true:autohint=true" };
...
static Rune stcursor = 0x2603; /* snowman ("Ã¢ËœÆ’") */
